...
namespace _qt_qml_content_ScreenExpert_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_content_Price_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_content_H1Text_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
Registry::Registry() {
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/content/ScreenExpert.qml"), &QmlCacheGeneratedCode::_qt_qml_content_ScreenExpert_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/content/Price.qml"), &QmlCacheGeneratedCode::_qt_qml_content_Price_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/content/H1Text.qml"), &QmlCacheGeneratedCode::_qt_qml_content_H1Text_qml::unit);
